-- SENTRY: Flak 38 20mm | smg1 | DMG:35 | Range:2500
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="Flak 38 20mm Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=0.1 self.BurstCount=0 self.BurstMax=6 self.BurstDelay=2.0
  self.NextBurstTime=0 self.Target=nil self.Range=2500 self.Damage=35 self.AmmoType="smg1"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.03,0.03,0),Tracer=1,Force=7,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
