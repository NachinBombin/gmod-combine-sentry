-- SENTRY: Flak 36 88mm | AR2AltFire | DMG:160 | Range:3500
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="Flak 36 88mm Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=2.0 self.BurstCount=0 self.BurstMax=1 self.BurstDelay=4.0
  self.NextBurstTime=0 self.Target=nil self.Range=3500 self.Damage=160 self.AmmoType="AR2AltFire"
