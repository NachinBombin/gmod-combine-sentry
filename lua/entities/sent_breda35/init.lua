-- SENTRY: Breda 35 37mm | AR2 | DMG:90 | Range:2800
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="Breda 35 37mm Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=0.6 self.BurstCount=0 self.BurstMax=4 self.BurstDelay=2.5
  self.NextBurstTime=0 self.Target=nil self.Range=2800 self.Damage=90 self.AmmoType="AR2"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.02,0.02,0),Tracer=1,Force=14,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
