-- SENTRY: GAU-19 Gatling | pistol | DMG:45 | Range:2500
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="GAU-19 Gatling Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=0.05 self.BurstCount=0 self.BurstMax=12 self.BurstDelay=3.0
  self.NextBurstTime=0 self.Target=nil self.Range=2500 self.Damage=45 self.AmmoType="pistol"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.04,0.04,0),Tracer=1,Force=9,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
  self:EmitSound("weapons/pistol/pistol_fire2.wav",85,math.random(95,105))
