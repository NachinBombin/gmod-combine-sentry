-- SENTRY: Flak 37 88mm | AR2AltFire | DMG:165 | Range:3500
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="Flak 37 88mm Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=1.8 self.BurstCount=0 self.BurstMax=1 self.BurstDelay=4.0
  self.NextBurstTime=0 self.Target=nil self.Range=3500 self.Damage=165 self.AmmoType="AR2AltFire"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.01,0.01,0),Tracer=1,Force=25,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
