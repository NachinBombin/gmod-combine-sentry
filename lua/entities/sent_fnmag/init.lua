-- SENTRY: FN MAG | smg1 | DMG:22 | Range:1800
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="FN MAG Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=0.08 self.BurstCount=0 self.BurstMax=8 self.BurstDelay=1.5
  self.NextBurstTime=0 self.Target=nil self.Range=1800 self.Damage=22 self.AmmoType="smg1"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.04,0.04,0),Tracer=1,Force=5,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
