-- SENTRY: GPF 155mm | grenade | DMG:250 | Range:4000
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="GPF 155mm Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=5.0 self.BurstCount=0 self.BurstMax=1 self.BurstDelay=8.0
  self.NextBurstTime=0 self.Target=nil self.Range=4000 self.Damage=250 self.AmmoType="grenade"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.04,0.04,0),Tracer=1,Force=40,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
