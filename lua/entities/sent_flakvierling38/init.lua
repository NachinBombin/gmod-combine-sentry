-- SENTRY: Flakvierling 38 | smg1 | DMG:40 | Range:2600
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="Flakvierling 38 Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=0.08 self.BurstCount=0 self.BurstMax=8 self.BurstDelay=2.5
  self.NextBurstTime=0 self.Target=nil self.Range=2600 self.Damage=40 self.AmmoType="smg1"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.03,0.03,0),Tracer=1,Force=8,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
