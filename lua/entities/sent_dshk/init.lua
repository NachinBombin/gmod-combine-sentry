-- SENTRY: DShK 12.7mm | pistol | DMG:55 | Range:2400
AddCSLuaFile()
ENT.Type="anim" ENT.Base="base_anim" ENT.PrintName="DShK 12.7mm Sentry"
...
function ENT:Initialize()
  ...
  self.NextFireTime=0 self.FireDelay=0.12 self.BurstCount=0 self.BurstMax=6 self.BurstDelay=1.8
  self.NextBurstTime=0 self.Target=nil self.Range=2400 self.Damage=55 self.AmmoType="pistol"
...
function ENT:Fire()
  ...
  self:FireBullets({Num=1,Src=m,Dir=d,Spread=Vector(0.03,0.03,0),Tracer=1,Force=10,Damage=self.Damage,AmmoType=self.AmmoType,AttackerTable={self}})
